...
// Package mock_sceptred is a generated GoMock package.
package mock_sceptred

import (
	gomock "github.com/golang/mock/gomock"
	reflect "reflect"
	server "sceptred/server"
)
...
func (m *MockSession) DB(name string) server.Database {
	ret := m.ctrl.Call(m, "DB", name)
	ret0, _ := ret[0].(server.Database)
	return ret0
}
...
// C mocks base method
func (m *MockDatabase) C(name string) server.Collection {
	ret := m.ctrl.Call(m, "C", name)
	ret0, _ := ret[0].(server.Collection)
	return ret0
}
...
func (m *MockCollection) FindId(id interface{}) server.Query {
	ret := m.ctrl.Call(m, "FindId", id)
	ret0, _ := ret[0].(server.Query)
	return ret0
}
